  ...
  const [isAdminLoggedIn, setIsAdminLoggedIn] = useState(false);
   ...
   const fetchUserDetails =useCallback( async () => {
    try {
      ...
      const response = await axios.get(`https://todo-check-api.onrender.com/api/user/compte/${userId}`, {
        headers: {
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Dashboard" element={isAdminLoggedIn ? 
          ...
          <Route path="compte/:id" element={<Compte utilisateur={utilisateur} userId={userId} fetchUserDetails={fetchUserDetails} />} />
